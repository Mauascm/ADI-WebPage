          ...
          <div className="space-y-4">
            <Card className="p-6 sm:p-7">
              ...
              <p className="mt-3 text-sm text-muted-foreground">
                No necesitas llegar con todo definido. Si el alcance todavía no está claro, estructuramos una Fase 0
                para bajar riesgo y priorizar con criterio.
              </p>
              ...
              {/* Configura NEXT_PUBLIC_ADI_CALENDAR_URL para habilitar este boton. */}
              <a
                ...
                className="mt-6 inline-flex h-11 items-center rounded-full border border-primary/50 px-6 text-sm text-primary transition hover:bg-primary/10 aria-disabled:pointer-events-none aria-disabled:opacity-50"
              >
                {hasCalendar ? "Abrir calendario" : "Placeholder: abrir calendario"}
              </a>
            </Card>
