      ...
      <Container>
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4 lg:col-span-2">
            ...
            >
              <span className="relative flex h-12 w-20 items-center justify-center overflow-hidden rounded-xl border border-border/70 bg-black/20">
                <span
                ...
                <Image
                  ...
                  width={768}
                  height={768}
                  className="relative h-16 w-16 scale-[1.7] object-contain drop-shadow-[0_0_18px_rgba(111,220,255,0.2)]"
                  aria-hidden="true"
                />
              </span>
